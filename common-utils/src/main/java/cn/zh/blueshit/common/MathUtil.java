 ...
 * 
 * 第二种：BigDecimal(String val) Translates the String repre sentation of a
 ...
 * 
 * public static double add(double v1,double v2) public static double sub(double
 * v1,double v2) public static double mul(double v1,double v2) public static
 * double div(double v1,double v2) public static double div(double v1,double
...
public class MathUtil {
	...
	public static BigDecimal add(BigDecimal num1,BigDecimal num2){
		...
		if(num2==null){
			num2 = new BigDecimal(0.00);
		}
		return round(num1.add(num2));
